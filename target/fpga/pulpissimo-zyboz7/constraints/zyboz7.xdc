...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_pulpissimo/i_clock_gen/i_clk_manager/inst/clk_out1]
...
# Constrain the JTAG DMI CDC
set_max_delay -datapath_only -through [get_pins i_pulpissimo/i_soc_domain/i_pulp_soc/i_dmi_jtag/i_dmi_cdc/*/*/async_*] -through [get_pins i_pulpissimo/i_soc_domain/i_pulp_soc/i_dmi_jtag/i_dmi_cdc/*/*/async_*] 10.000

# reset signal
set_max_delay -datapath_only -from [get_ports pad_reset] 16.000
...
# Create asynchronous clock group between JTAG TCK and everything else
